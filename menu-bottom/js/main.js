...
/* 
    ...
    icon-burger, nav-header y ul-header
*/
...
$iconBurger.addEventListener('click', () => {
    /* 
        añadimos o removemos de $navHeader la clase js_bg_color  
        definida en la hoja de estilos
    */
	$navHeader.classList.toggle('js_bg_color');

    /* 
        añadimos o removemos de $ulHeader la clase js_show_menu 
        definida en la hoja de estilos
    */
